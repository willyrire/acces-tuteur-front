...
const Danger = ({
  ...
  return (
    <div className="left-0 w-full z-40 bg-red-400 border-b-2 border-red-600">
      <div
        ...
        <div className="flex items-center align-baseline">
          {hasButton && (
            <button
              ...
              className="hover:cursor-pointer bg-red-600 hover:bg-red-700 text-white font-semibold px-4 py-2 rounded transition-colors duration-200"
            >
          ...
          <button
            onClick={onClose}
            className="hover:cursor-pointer ml-3 bg-red-400 rounded-full hover:bg-red-300 px-4 py-4 transition"
          >
